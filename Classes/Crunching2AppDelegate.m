...
#import "Crunching2AppDelegate.h"
#import "Config.h"
...
@implementation Crunching2AppDelegate
...
- (void) applicationDidFinishLaunching:(UIApplication*)application
{
	...
	[[CCDirector sharedDirector] runWithScene: [CrunchPreloader scene]];
...
-(void) applicationDidEnterBackground:(UIApplication*)application {
	...
	//在此保存必要的数据
	[[GameRecordManager sharedManager] saveGameDataToLocal];
